...
public class Comanda {
    ...
    // Campo para indicar si la comanda está pagada
    ...
    public Boolean getPagada() {
        return pagada != null ? pagada : false;
    }
    
    public void setPagada(Boolean pagada) {
        this.pagada = pagada != null ? pagada : false;
    }
    ...
    // Método para verificar si la comanda está pagada
    public boolean estaPagada() {
        return getPagada() != null && getPagada();
    }
